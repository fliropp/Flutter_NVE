...
final ldfrbcPath = '/hydrology/forecast/avalanche/v4.0.0/api/AvalancheWarningByCoordinates/Simple/';
final language = "1";
final salten = "3016";
...
Future<List<String>> loadDataForRegionByCoordinates(String long, String lat) async{
  var httpClient = new HttpClient();
  var uri = new Uri.http(domain, ldfrbcPath + lat + "/" + long + '/' + language);
